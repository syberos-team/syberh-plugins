...
public:
    ...
    bool query(const QString &sql, const QMap<int,QVariant> &params, CellRecordHandleFunc cellHandle, QString *err);

    bool query(const QString &sql, const QMap<QString,QVariant> &params, CellRecordHandleFunc cellHandle, QString *err);

    bool queryMap(const QString &sql, RowMapHandleFunc rowHandle, QString *err);

    bool queryMap(const QString &sql, const QMap<int,QVariant> &params, RowMapHandleFunc rowHandle, QString *err);

    bool queryMap(const QString &sql, const QMap<QString,QVariant> &params, RowMapHandleFunc rowHandle, QString *err);
    ...
    bool exec(const QString &sql, const QMap<int,QVariant> &params, QString *err);
